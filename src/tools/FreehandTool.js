...
export class FreehandTool extends DrawingTool {
    get id() { return 'freehand'; }
    get name() { return N_('Freehand'); }
    get icon() { return 'document-edit-symbolic'; }
    get keybindings() { return [Clutter.KEY_3, Clutter.KEY_quotedbl, Clutter.KEY_f]; }
