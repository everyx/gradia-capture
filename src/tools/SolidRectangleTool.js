...
export class SolidRectangleTool extends DrawingTool {
    get id() { return 'solid-rectangle'; }
    get name() { return N_('Solid Rectangle'); }
    get icon() { return 'icons/square-filled-symbolic.svg'; }
    get keybindings() { return [Clutter.KEY_5, Clutter.KEY_parenleft, Clutter.KEY_b]; }
    get propSchema() { return [{ key: 'color', type: 's', default: '#000000' }]; }
    bounds(s) { return rectBounds(s.stagePoints, SELECTION_PADDING); }
