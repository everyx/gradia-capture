...
export class RectangleTool extends DrawingTool {
    get id() { return 'rectangle'; }
    get name() { return N_('Rectangle'); }
    get icon() { return 'icons/square-outline-thick-symbolic.svg'; }
    get keybindings() { return [Clutter.KEY_4, Clutter.KEY_apostrophe, Clutter.KEY_r]; }
    get propSchema() { return [{ key: 'color', type: 's', default: '#000000' }, { key: 'size', type: 'd', default: 3 }]; }
    bounds(s) { return rectBounds(s.stagePoints, SELECTION_PADDING + (s.strokeWidth ?? 4)); }
